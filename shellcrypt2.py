...
# -*- coding: utf-8 -*-
"""
shellcrypt22.py - Shellcode Obfuscation Toolkit
=============================================
...
def build_parser():
    ...
    p.add_argument("-f", "--format", choices=["bin", "txt", "c", "py", "asm"], default="bin",
                   help="output format: bin raw bytes, txt text form, c/py source, "
